...
import { getLevelDirectoryEntries } from "@/lib/seoQueries";

const title = "SNHU Transfer Academic Levels";
const description =
  "Browse unofficial SNHU transfer equivalencies by academic level.";
const canonical = canonicalPath("/levels", siteUrl);
      ...
      >
        <section className="rounded-lg border border-surface-variant bg-surface-container-low p-5">
          <h1 className="font-[family-name:var(--font-headline)] text-2xl font-semibold text-primary md:text-3xl">
            SNHU Transfer Academic Levels
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-on-surface-variant md:text-base">
            Alphabetical list of academic levels with listed transfer equivalency options.
          </p>
        </section>
