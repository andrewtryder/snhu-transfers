        ...
        <article aria-labelledby="about-heading">
          ...
          <section aria-label="Related tools" className="mt-8 space-y-4">
            ...
            <p className="text-sm leading-relaxed text-on-surface-variant">
              After reviewing transfer equivalencies, use{" "}
              <a href="https://snhu-degreemap.vercel.app" className="font-semibold text-primary hover:underline">
                SNHU Degree Map
              </a>{" "}
              to see how SNHU courses fit into program requirements.
            </p>
            <div className="grid gap-3">
              ...
              >
                <div className="min-w-0">
                  <p className="font-semibold text-primary group-hover:underline">Course Prerequisites</p>
              ...
              >
                <div className="min-w-0">
                  <p className="font-semibold text-primary group-hover:underline">Degree Map</p>
                  <p className="mt-1 text-sm text-on-surface-variant">
                    Browse SNHU programs and visualize how courses fit into degree requirements.
                  </p>
                </div>
                <ArrowUpRight
                  className="mt-0.5 h-5 w-5 shrink-0 text-outline transition-colors group-hover:text-primary"
